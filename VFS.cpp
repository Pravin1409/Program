...
void man(char*name)
{
    ...
    {
        printf("Discription: Use to write into regular file\n");
        printf("Usages: write File_name\n After this enter the data that we want to write\n");
    }

    else if(strcmp(name,"ls")==0)
    {
        printf("Discription: Used to list all information\n");
        printf("Usages:ls\n");
    }
    ...
    {
        printf("Discription: Used to Display information of file\n");
        printf("Usages: stat File_Descriptor \n");
    }
    ...
    {
        printf("Discription: Use to open existing file\n");
        printf("Usage:open File_name\n");
    }

    else if(strcmp(name,"close")==0)
    {
        printf("Discription:Used to close open file\n");
        printf("Usages:close File_name \n");
    }

    else if(strcmp(name,"closeall")==0)
    {
        printf("Discription:Used to close al opened file\n");
        printf("Usages: closeall\n");
    }

    else if(strcmp(name,"lseek")==0)
    {
        printf("Discription: Used to change offset\n");
    ...
    {
        printf("ERROR:No manual entery availabe.\n");
    }
}
...
void DisplayHelp()
{
    ...
    printf("open: To open tge file\n");
    printf("close: To close the file\n");
    printf("claseall: To close all open file\n");
    printf("read:To read the comtent of file\n");
    printf("write: To writ the content into the file\n");
...
void CreatDILB()
{
    ...
    printf("DILB create Succesfully\n");
...
int CreateFile(char*name,int permission)
{
    ...
    strcmp(UFDTArr[i].ptrfiletable->ptrinode->FileName,name);
 ...
 // rm_File("Demo.txt")
   ...
   int stat_file(char*name)
   {
       ...
       printf("\n-----Statical Information about fil-------\n");
       printf("File name:%s\n",temp->FileName);
       printf("Inode Number :%d\n",temp->InodeNumber);
       printf("File Size:%d\n",temp->FileSize);
       printf("Actual File size:%d\n",temp->FileActualSize);
   ...
   int main()
   {
       ...
       while(1)
       {
           ...
           if(count==1)
           {
               ...
               {
                   printf("Terminating the Marvelous file Virtual file System\n");
                   break;
               }
               else
               {
           ...
           else if(count==2)
           {
               if(strcmp(command[0],"stat")==0)
               {
                   ...
                   if(ret==-2)
                    printf("ERROR:Their is no such a file\n");
                    continue;
               }
               ...
               else if(strcmp(command[0],"close")==0)
               {
                   ...
                   if(ret==-1)
                    printf("ERROR:Their is no sucnh file\n");
                    continue;
               }
               ...
               else if(strcmp(command[0],"write")==0)
               {
                   ...
                   if(ret==-2)
                   printf("ERRO:Their is no Sufficient memory to write\n");
                   if(ret==-3)
           ...
           else if(count==3)
           {
               if(strcmp(command[0],"create")==0)
               {
                   ...
                   if(ret>=0)
                    printf("File is Succesfully created with file discriptor:%d\n",ret);
                   if(ret==-1)
                    printf("ERROR:Incorrect parameter\n");
                   if(ret==-2)
                    printf("ERROR:There is no inodes\n");
                   if(ret==-3)
                    printf("ERROR:File Alredy exits\n");
                   if(ret==-4)
               ...
               else if(strcmp(command[0],"open")==0)
               {
                   ...
                   if(ret>=0)
                    printf("File is Succefully opened with file descriptor:%d\n",ret);
                   if(ret==-1)
                    printf("ERROR: Incorrect parameter\n");
                   if(ret==-2)
